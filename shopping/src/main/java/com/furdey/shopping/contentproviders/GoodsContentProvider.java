...
public class GoodsContentProvider extends BaseContentProvider<Columns> {
    ...
    public static enum Columns implements BaseContentProvider.Columns {
        _id("goods._id"), CHANGED("goods.changed"), DELETED("goods.deleted"),
        STANDARD("goods.standard"), SYNCHRONIZEDTM("goods.synchronizedtm"),

        NAME("goods.name"), DEFAULTUNITS_ID("goods.defaultUnits_id"),
        CATEGORY_ID("goods.category_id"), NAME_LOWER("goods.name_lower"),
    ...
    public static void addColumn(Context context, String columnName, String columnType) {
        addColumn(context, GOODS_PATH, columnName, columnType);
    }
}