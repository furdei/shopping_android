...
//                .concat(" AND (").concat(Columns.STATE.getDbName()).concat(" = '")
//                .concat(Purchase.PurchaseState.ENTERED.toString()).concat("' OR (")
//                .concat(Columns.STATE.getDbName()).concat(" = '")
//                .concat(Purchase.PurchaseState.ACCEPTED.toString()).concat("' AND '")
//                .concat(ContentUtils.getDateFormat().format(new Date())).concat("' <= ")
//                .concat(Columns.FINDATE.getDbName()).concat("))")
