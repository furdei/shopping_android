...
public class FileHelper {
	 ...
	 * comments and all sql statements must end with a semi-colon ";" in order for
	 * the file to be parsed correctly. The sql statements in the String array
	 * will not end with a semi-colon ";".
	 * 
	 * @param sqlFile
