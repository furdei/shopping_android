...
public class GoodsCategoryNameValidator extends EditTextValidator {

	public GoodsCategoryNameValidator(int order, String errorMessage,
	...
	public void validate(ValidationErrorList errorList) {
		try {
			if (((DatabaseHelper)getActivity().getDaoHelper()).getGoodsCategoriesDao().isNameAlreadyExists(
